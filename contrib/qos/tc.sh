...
LINKCEIL="1gbit"
#limit outbound Cryptonodes protocol traffic to this rate
LIMIT="160kbit"
...
iptables -t mangle -A OUTPUT -p tcp -m tcp --dport 44219 ! -d ${LOCALNET} -j MARK --set-mark 0x2
iptables -t mangle -A OUTPUT -p tcp -m tcp --sport 44219 ! -d ${LOCALNET} -j MARK --set-mark 0x2
