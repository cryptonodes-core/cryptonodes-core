...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/cryptonodes-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/cryptonodes-cli.cpp \
           src/cryptonodes-tx.cpp \
           src/cryptonodes.cpp \
           src/db.cpp \
           ...
           src/qt/cryptonodes.cpp \
           src/qt/cryptonodesstrings.cpp \
...
RESOURCES += src/qt/cryptonodes.qrc src/qt/cryptonodes_locale.qrc

TRANSLATIONS += src/qt/locale/cryptonodes_bg.ts \
                src/qt/locale/cryptonodes_de.ts \
                src/qt/locale/cryptonodes_en.ts \
                src/qt/locale/cryptonodes_es.ts \
                src/qt/locale/cryptonodes_fi.ts \
                src/qt/locale/cryptonodes_fr.ts \
                src/qt/locale/cryptonodes_it.ts \
                src/qt/locale/cryptonodes_ja.ts \
                src/qt/locale/cryptonodes_pl.ts \
                src/qt/locale/cryptonodes_pt.ts \
                src/qt/locale/cryptonodes_ru.ts \
                src/qt/locale/cryptonodes_sk.ts \
                src/qt/locale/cryptonodes_sv.ts \
                src/qt/locale/cryptonodes_vi.ts \
                src/qt/locale/cryptonodes_zh_CN.ts \
                src/qt/locale/cryptonodes_zh_TW.ts
