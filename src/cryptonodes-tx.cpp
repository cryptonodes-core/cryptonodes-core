...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cryptonodes Core cryptonodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptonodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptonodes transaction") + "\n" +
                               "  cryptonodes-tx [options] -create [commands]   " + _("Create hex-encoded cryptonodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptonodes transaction
