...
/** Utility functions used by the Cryptonodes Qt UI.
 */
namespace GUIUtil
{
...
// Render CNMC addresses in monospace font
...
// Parse "cryptonodes:" URI into recipient object, return true on successful parsing
