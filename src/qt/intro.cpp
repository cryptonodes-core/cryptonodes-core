...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptonodes Core"),
     ...
     * override -datadir in the cryptonodes.conf file in the default data directory
     * (to be consistent with cryptonodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
