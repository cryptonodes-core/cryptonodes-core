                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cryptonodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CNMC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptonodes: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cryptonodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cryptonodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cryptonodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CNMC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CNMC addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptonodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cryptonodes Core help message to get a list with possible Cryptonodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cryptonodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptonodes network", "", count));
}
...
{
    QString strTitle = tr("Cryptonodes Core"); // default title
