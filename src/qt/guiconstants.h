...
/* Cryptonodes GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cryptonodes"
#define QAPP_ORG_DOMAIN "cryptonodes.ch"
#define QAPP_APP_NAME_DEFAULT "Cryptonodes-Qt"
#define QAPP_APP_NAME_TESTNET "Cryptonodes-Qt-testnet"
